...
(function e(t, n, r) {
  function s(o, u) {
    ...
    (function () {
      ...
      pathFromUrl = function pathFromUrl(url) {
        var path;
      ...
      pickBestMatch = function pickBestMatch(path, objects, pathFunc) {
      ...
      numberOfMatchingSegments = function numberOfMatchingSegments(path1, path2) {
      ...
      pathsMatch = function pathsMatch(path1, path2) {
